...
@Named
@SessionScoped
public class ControladorAgregarCliente implements Serializable {
	...
	public ControladorAgregarCliente() {
	}
	...
	public void guardar() {
		...
		FacesContext.getCurrentInstance().addMessage(null, 
			new FacesMessage(FacesMessage.SEVERITY_INFO, "Cliente creado correctamente.", "")
		);
	}
}
